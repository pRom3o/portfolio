      ...
      <div class="flex flex-col items-center h-full w-full md:p-3">
        <div class="w-full mt-18 md:mt-8 mb-8">
          ...
          <p class="text-sm fonts-light text-black/70">
            Explore my portfolio, where captivating design ideas are brought to
            life, a place where passion meets curiosity to shape projects I'm
            truly proud of.
          </p>
        </div>
        <div
        ...
        >
          ...
          <div class="grid md:grid-cols-2 grid-cols-1 h-[90%] w-full gap-3">
            <div
            ...
            >
              ...
              />
              <div class="md:h-[50%] w-full flex flex-col space-y-16 p-5">
                <div class="w-full flex items-center justify-between">
                  <p class="font-bold text-xl text-gray-800/90 flex flex-col">
            ...
            >
              ...
              <div class="md:h-[50%] w-full flex flex-col space-y-16 p-5">
                <div class="w-full flex items-center justify-between">
                  <p class="font-bold text-xl text-gray-800/90 flex flex-col">
                    Space tourism website<span class="font-light text-sm"
                      >July 2025</span
                    >
                  </p>
                  <a
            ...
            >
              ...
              <div class="md:h-[50%] w-full flex flex-col space-y-16 p-5">
                <div class="w-full flex items-center justify-between">
                  <p class="font-bold text-xl text-gray-800/90 flex flex-col">
                    Advice generator website<span class="font-light text-sm"
                      >Dec 2024</span
                    >
                  </p>
                  <a
